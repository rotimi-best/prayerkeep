export default {
  wade: {
    title: "WADE",
    introduction: "In the spirit wade means love, friendship, and or, fear.",
    meanings: [
  ...
  walk: {
    ...
    bibleVerse: "Galatians 5:16, 25; Ephesians 4:1."
  },
  wall: {
    title: "WALL",
    introduction:
    ...
    bibleVerse: "Joshua 6:1, Zechariah 2:5"
  },
  wail: {
    title: "WAIL",
    introduction: "",
    ...
    bibleVerse: "2 Samuel 22:30, Nahum 2:5, Proverbs 18:11."
  },
  wallet: {
    title: "WALLET",
    introduction: "In the spirit wallet represent treasure, precious,valuable.",
    meanings: [
    ...
    bibleVerse: "Matthew 6:21. John 12:6"
  },
  walkingStick: {
    title: "WALKING STICK",
    introduction: "",
  ...
  wand: {
    title: "WAND",
    introduction: "In the spirit wand, represent authority or security.",
    meanings: [
  ...
  wash: {
    ...
    bibleVerse: "Isaiah 1:16, Jeremiah 4:14. Psalms 51:7, John 15:3,Job 14:4"
  },
  wasp: {
    title: "WASP",
    introduction: "In the spirit wasp mean relationship, and or,warning.",
    meanings: [
  ...
  watchman: {
    title: "WATCHMAN",
    introduction: "",
    meanings: ["To see one means safety."],
    bibleVerse: ""
  },
  water: {
    title: "WATER",
    introduction: "The meaning depend on the details and the action.",
    meanings: [
    ...
    bibleVerse:
      "Proverbs 18:4, Ephesians 5:26, Amos 8:11, Genesis 21:6, Isaiah 57:20, Job 34:7, James 3:11, Revelation 21:6."
  },
  watermelon: {
    title: "WATERMELON",
    introduction:
    ...
    meanings: [
      "If you dream of watermelon on the vine it against casual love affairs it means warning against casual love affairs.",
      "If you see one ordinarily it portends travel.",
      "To lick its water means spirit advancement.",
      "To eat sweet one mean strength.",
      "To see one that is green mean life abundance.",
      "To see red or ripe one in the dream means passion."
    ],
    bibleVerse: "Numbers 11:5, Proverbs 1:31, Isaiah 3:10, Proverbs 18:21"
  },
  waterMill: {
    title: "WATER MILL",
    introduction: "",
  ...
  waterWell: {
    ...
    bibleVerse: "Proverbs 4:23, 2 Peter 2:17, John 4:10"
  },
  wealth: {
    title: "WEALTH",
    introduction:
  ...
  weather: {
    ...
    meanings: [
      ...
      "To see weather vane is a good omen if your prime concern is business, but if you are into romance be prepared for stormy weather."
    ],
    bibleVerse: "Matthew 16:2"
  },
  weaving: {
    title: "WEAVING",
    introduction: "",
    meanings: [
      ...
      "If you dreamed you were doing the weaving well; in the dream expect peace of mind and contentment to follow in your pursuit.",
      "When you dream having difficulty with the threads or loom expect obstacles to overcome.",
      "To dream of watching someone else at a loom is forecast of solid achievement in your current endeavor."
    ],
    bibleVerse: ""
  },
  web: {
  ...
  wedding: {
    title: "WEDDING",
    introduction: "In the spirit wedding foretells covenant or agreement.",
    meanings: [
      ...
      "To dream you wed to an unknown face in the dream portends bad omen of marriage to spirit husband or wife.",
    ...
    bibleVerse:
      "Ephesians 5:31-32, Exodus 23:32, 2 Corinthians 6:14, Revelation 2:12"
  },
  weed: {
    title: "WEED",
    introduction:
      "Generic meaning of weeds connotes fullness of iniquity, works of the flesh, neglect, worry, laziness.",
    meanings: [
    ...
    bibleVerse: "Genesis 2:15, Genesis 15:16, Jonah 2:5, Proverbs 24:30-31"
  },
  weighing: {
    title: "WEIGHING",
    introduction: "In the spirit weighing mean judgment,guard.",
    meanings: [
  ...
  west: {
    ...
    bibleVerse: "Exodus 10:19, Psalms 103:12, Luke 12:54."
  },
  western: {
    title: "WESTERN",
    introduction:
  ...
  wheat: {
    ...
    meanings: [
      ...
      "If you dream of one harvested or in sheaves, it forecasts solid achievement in your current endeavor."
    ],
    bibleVerse: "Mathews 3:12"
  },
  wheel: {
    title: "WHEELS",
    introduction: "",
    meanings: [
      ...
      "In every dream situation ensure you pray prayers of manifestations for every positive expectation and cancel every negative dream that won't bring favorable result. Apply turn around prayer for negatives to positives."
    ],
    bibleVerse: "Ezekiel 1:16"
  },
  wheelBarrow: {
    title: "WHEEL BARROW",
    introduction: "",
  ...
  whip: {
    title: "WHIP",
    introduction: "In the spirit whip connotes, justice, peace and caution.",
    meanings: [
    ...
    bibleVerse: "Matthew 27:26."
  },
  whirlpool: {
    title: "WHIRLPOOL",
    introduction:
      "n the spirit whirlwind portends discouragement, confusion or fear.",
    meanings: [
  ...
  whirlwind: {
    title: "WHIRLWIND",
    introduction:
      "In the spirit whirlwind connotes, destruction, attack, and confusion.",
    meanings: [
      "When you see this revolving mass of air in the dream, it means spiritual attack upon, your destiny. It also means you need sudden changes which will require quick decision"
    ],
    bibleVerse: "2 Kings 2:1"
  },
  whisper: {
    title: "WHISPER(S)",
    introduction: "",
  ...
  whistle: {
    title: "WHISTLE",
    introduction:
      "In the spirit whistle mean criticism, surprise, judgment and caution.",
    meanings: [
      "If you whistle in the dream expect to cope with some unjust criticism. If you dream and heard others whistling, you are warned to revise or delay a current plan or project."
    ],
    bibleVerse: ""
  },
  white: {
    ...
    meanings: [
      ...
      "This color white in general terms is a promise of success in all that concerns you. Continue to live a holy life and be prayerful."
    ],
    bibleVerse: "Revelation 19:8; 2 Kings 5:27."
  },
  whitewash: {
    title: "WHITEWASH",
    introduction: "In the spirit whitewash connotes assistance or courage.",
    meanings: [
  ...
  wind: {
    title: "WIND",
    introduction:
      "In the spirit wind connotes, Holy Spirit, strong opposition, idle words",
    meanings: [
    ...
    bibleVerse: "Ephesians 4:14, John 3:8, Acts 2:2, Job 8:2, Proverbs 125:23"
  },
  windwill: {
    title: "WINDMILL",
    introduction:
  ...
  wife: {
    title: "WIFE",
    introduction:
      "In spirit a wife connotes, covenant, dedication, joined, job, business, hobby, church.",
    meanings: [
    ...
    bibleVerse: "Galatians 4:24, Ephesians 5:23, I Corinthians 7:33."
  },
  wine: {
    title: "WINE",
    introduction:
      "Generic meanings to wine are joy, health, prosperity, anger, sorrow, witchcraft, truth.",
    meanings: [
    ...
    bibleVerse: "Ephesians 5:18, Luke 5:37, Proverbs 31:6, Proverbs 4:17."
  },
  wings: {
    title: "WINGS",
    introduction:
      "In spirit wings portends victory, minister, Holy Spirit, shelter, witchcraft.",
    meanings: [
    ...
    bibleVerse: "Hosea 12:13, Exodus 19:4 Psalms 91:4, Isaiah 40:31."
  },
  wink: {
    title: "WINK",
    introduction: "",
    meanings: [
      "To see this feature in a dream suggests you should be more careful in your love life."
    ],
    bibleVerse: "Proverbs 6:25"
  },
  winter: {
    title: "WINTER",
    introduction: "",
    meanings: ["Winter in the dream connotes death, dormant or cold"],
    bibleVerse: "Jeremiah 8:20, Isaiah 1:30."
  },
  wishingWell: {
    title: "WISHING WELL",
    introduction: "",
  ...
  witch: {
    title: "WITCH",
    introduction:
      "Generic meaning of a witch includes rebellion, negative control, evil influence, evil intent, disobedience, gossip, worldly church and seduction.",
    meanings: [
      "If you are in love affair with this evil creature it portends evil initiation, seduction and poverty in the offing."
    ],
    bibleVerse: "Samuel 15:23, I' Kings 21:25, Revelation 2:20."
  },
  wolf: {
    title: "WOLF",
    introduction:
      "In the spirit wolf portends devourer, evil power, false prophet, and womanizer.",
    meanings: [
    ...
    bibleVerse: "Matthew 7:15, Acts. 20:29."
  },
  womb: {
    title: "WOMB",
    introduction: "In the spirit womb connotes fruitfulness and joy.",
    meanings: [
  ...
  women: {
    title: "WOMEN",
    introduction:
      "Generic meaning for women include, seducing spirit, deception, witchcraft, temptation, happiness.",
    meanings: [
    ...
    bibleVerse: "Proverbs 2:16, Luke 13:21, Proverbs 23:27"
  },
  wounds: {
    title: "WOUNDS",
    introduction: "",
  ...
  wood: {
    ...
    bibleVerse: "Jeremiah 5:14, Proverbs 26:20, Proverbs 26:20."
  },
  work: {
    title: "WORK",
    introduction: "",
  ...
  worms: {
    ...
    introduction: "",
    meanings: [
      "To use worms as baits predicts sudden mater gains. Seeing worms in the dream signifies illness.If you kill them or see them dead all over places it means recovery from ill health, successful efforts and happiness."
    ],
    bibleVerse: "Acts 12:23."
  },
  wrap: {
    title: "WRAP",
    introduction: "",
  ...
  wren: {
    title: "WREN",
    introduction: "",
    meanings: ["To see this little bird in the dream portends pleasant news."],
    bibleVerse: ""
  },
  wrestle: {
    title: "WRESTLE",
    ...
    bibleVerse: "Genesis 32:24,  Ephesians 6:12, 2 Timothy 2:24, Zephaniah 3:5"
  },
  write: {
    title: "WRITE",
    introduction: "",
    meanings: [
      ...
      "If you were doing the writing in the dream, it is saying you problems for yourself through impulsive are creating  behavior. Therefore, think before you act.",
      "If you see others writing it means to be your own best. Do not allow others influence your judgment.",
      "To see writing materials in the dream portends wisdom and knowledge."
    ],
    bibleVerse: "Proverbs 13:20, Isaiah 30:8"
  },
}